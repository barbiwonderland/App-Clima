...
<p>Humedad: ${Math.round(data.main.humidity)}% </p>
       ...
       if (data.weather[0].description.includes("chubasco" ||"lluvia") ){
            ...
            imagen.style.backgroundImage= "url('imagenes/lluvia.jpg')"; document.body.style.backgroundSize="cover"; 
      ...
      imagen.style.backgroundImage="url('imagenes/otoño.jpg')"; document.body.style.backgroundSize="cover"; 
  

     
 }else{
   
        document.body.style.backgroundImage="url('imagenes/calor.jpg')"; document.body.style.backgroundSize="cover";
