...
<p>Humedad: ${Math.round(data.main.humidity)}% </p>
       ...
       `;
 if (data.main.temp<10) {document.body.style.background= "url('https://ng.kcsd.org/wp-content/uploads/sites/7/2020/01/snow-720x477.jpg')"; document.body.style.backgroundSize="cover";
